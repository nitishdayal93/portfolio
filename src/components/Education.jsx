    ...
    <section id="education">
      ...
      <div className="mt-4 space-y-6">
        <motion.div 
          ...
          className="p-4 rounded-lg bg-[#071025]/60 border border-slate-800">
          <div className="font-medium text-xl mb-2">Master of Computer Application (MCA)</div>
          <div className="text-md text-slate-300 mb-4">Lovely Professional University, Phagwara, Punjab, India</div>
        ...
        <motion.div 
          ...
          <div className="text-md text-slate-300 mb-4">Indira Gandhi Open University, Patna — 2022–2025</div>
          <div className="w-full h-48 md:h-64 overflow-hidden rounded-lg">
            <img 
              src="/images (1).jpg" 
              alt="IGNOU Campus" 
